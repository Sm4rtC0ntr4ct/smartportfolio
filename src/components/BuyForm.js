...
const BuyForm = ({ walletBalance, ioTokenWalletBalance, buyTokens }) => {
  ...
  return (
    <form className="mb-3" onSubmit={handleSubmit}>
      <div>
        ...
        <span className="float-right text-muted">Balance: {walletBalance}</span>
      </div>
      ...
      <div>
        ...
        <span className="float-right text-muted">
          Balance: {ioTokenWalletBalance.toString()};
        </span>
      </div>
      ...
      <div className="mb-5">
        ...
        <span className="float-right text-muted">1 ETH = 100 IO-Tokens</span>
      </div>
